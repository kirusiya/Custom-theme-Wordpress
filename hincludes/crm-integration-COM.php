<?php
	...
	if($code=="200" || $duplicado) {
		...
		if($perfilcliente_fc=="Stone mason"){
			$z_tipo_cliente=51;
		}
		else if($perfilcliente_fc=="Architect"){
			$z_tipo_cliente=38;
		}
		else if($perfilcliente_fc=="Interior designer"){
			$z_tipo_cliente=50;
		}
		else if($perfilcliente_fc=="Distributor"){
			$z_tipo_cliente=43;
		}
		else if($perfilcliente_fc=="Private customer"){
			$z_tipo_cliente=53;
		}
		else if($perfilcliente_fc=="Countertops supplier"){
			$z_tipo_cliente=56;
		}
