<?php
	...
	if($code=="200" || $duplicado) {
		...
		if($perfilcliente_fc=="Verarbeiter"){
			$z_tipo_cliente=51;
		}
		else if($perfilcliente_fc=="Architekt"){
			$z_tipo_cliente=38;
		}
		else if($perfilcliente_fc=="Designer/Innenarchitekt"){
			$z_tipo_cliente=50;
		}
		else if($perfilcliente_fc=="Verteiler"){
			$z_tipo_cliente=43;
		}
		else if($perfilcliente_fc=="Privatkunde"){
			$z_tipo_cliente=53;
		}
		else if($perfilcliente_fc=="Arbeitsplatten geschäft"){
			$z_tipo_cliente=56;
		}
