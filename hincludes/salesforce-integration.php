<?php
    ...
    $AccountType    = $array_data['accounttype'];
    $CompanyEmail   = $array_data['email'];

    /**nuevos campos */
    $TipoDeLead     = $array_data['tipolead'];
	...
	if (strpos($cookie, 'direct') !== false) { 
		...
		//'rrss orgánico'; 	
		$LeadSource = 'Facebook Organico';// LeadGroupSource__c = RRSS Orgánico (asumo que cualquier red social aca es organico)
	} 
