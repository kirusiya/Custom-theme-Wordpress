...
<div class="animation animation-home">
	<img class="pic pic1" src="<?php echo esc_url( get_stylesheet_directory_uri() ); ?>/images/animations/animation-home/animation-1.png" alt="Animación 1">
	<img class="pic pic2" src="<?php echo esc_url( get_stylesheet_directory_uri() ); ?>/images/animations/animation-home/animation-2.png" alt="Animación 2">
	<img class="pic pic3" src="<?php echo esc_url( get_stylesheet_directory_uri() ); ?>/images/animations/animation-home/animation-3.png" alt="Animación 3">
</div>
