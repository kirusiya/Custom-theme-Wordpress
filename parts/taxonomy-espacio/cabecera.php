		...
		<div class="col-md-6 izq">
			<div class="inner">
				...
				<div class="boton-cupa-granate">
					<?php $enlace_espacio = '/' . esc_html( $prod_slug ) . '/?tax=' . esc_html( $currentTaxName ) . '&term_id=' . $currentTaxID; //phpcs:ignore ?>
					<a href="<?php echo esc_url( $enlace_espacio ); ?>">
